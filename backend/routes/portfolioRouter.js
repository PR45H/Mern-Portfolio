...
const { healthCheck, getPortfolioData, updateIntro, updateAbout, updateSkills, updateProjects } = require("../config/portfolio.controller")
...
portfolioRouter.post('/update-projects', updateProjects);
